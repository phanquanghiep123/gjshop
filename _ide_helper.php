 ...
 * Generated for Laravel 5.2.35 on 2016-06-28.
 *
...
namespace {
    ...
    class Uploader extends \Modules\Uploader\Uploader{
         ...
         * @static 
         */
        public static function singleRender($name){
            return \Modules\Uploader\Uploader::singleRender($name);
        }
        ...
        public static function swap($instance){
            ...
            \Modules\Uploader\Uploader::swap($instance);
        }
        ...
        public static function shouldReceive(){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            return \Modules\Uploader\Uploader::shouldReceive();
        }
        ...
        public static function getFacadeRoot(){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            return \Modules\Uploader\Uploader::getFacadeRoot();
        }
        ...
        public static function clearResolvedInstance($name){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Modules\Uploader\Uploader::clearResolvedInstance($name);
        }
        ...
        public static function clearResolvedInstances(){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Modules\Uploader\Uploader::clearResolvedInstances();
        }
        ...
        public static function getFacadeApplication(){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            return \Modules\Uploader\Uploader::getFacadeApplication();
        }
        ...
        public static function setFacadeApplication($app){
            //Method inherited from \Illuminate\Support\Facades\Facade            
            \Modules\Uploader\Uploader::setFacadeApplication($app);
        }
        
    }


    class Imagecache extends \Modules\Devfactory\Imagecache\Facades\ImagecacheFacade{
         ...
         * @return array Containing the cached image src, img, and others
         * @static 
         */
        public static function get($file, $preset, $args = null){
            return \Modules\Devfactory\Imagecache\Imagecache::get($file, $preset, $args);
        }
         ...
         * @param $file mixed
         *  Object/array/string to check for a filename
         * @return array An array containing to different image setups
         * @static 
         */
        public static function get_original($file, $args = null){
            return \Modules\Devfactory\Imagecache\Imagecache::get_original($file, $args);
        }
        
        /**
         * Delete each imagecache for the given image
         *
         * @param \Modules\Devfactory\Imagecache\file_name
         * @return  
         * @static 
         */
        public static function delete($file_name){
            return \Modules\Devfactory\Imagecache\Imagecache::delete($file_name);
        }
        
    }


    class Thumbnailer extends \Modules\Thumbnailer\Thumbnailer{
    ...
    class DbExportHandler extends \Nwidart\DbExporter\Facades\DbExportHandler{
         ...
         * @static 
         */
        public static function migrate($database = null){
            return \Nwidart\DbExporter\DbExportHandler::migrate($database);
        }
         ...
         * @static 
         */
        public static function seed($database = null){
            return \Nwidart\DbExporter\DbExportHandler::seed($database);
        }
         ...
         * @static 
         */
        public static function migrateAndSeed($database = null){
            return \Nwidart\DbExporter\DbExportHandler::migrateAndSeed($database);
        }
        ...
        public static function ignore($tables){
            return \Nwidart\DbExporter\DbExportHandler::ignore($tables);
        }
         ...
         * @static 
         */
        public static function getMigrationsFilePath(){
            return \Nwidart\DbExporter\DbExportHandler::getMigrationsFilePath();
        }
         ...
         * @static 
         */
        public static function uploadTo($remote){
            return \Nwidart\DbExporter\DbExportHandler::uploadTo($remote);
        }
