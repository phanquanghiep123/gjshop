  ...
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="panel bg-warning light of-h mb10">
      <div class="pn pl20 p5">
        ...
        <h2 class="mt15 lh15">
          <b>{{ $ordersAwaitingPost }}</b>
        </h2>
        <h5 class="text-muted"><a href="{{ route('gjadmin.shop.orders.index') }}">Orders waiting to be despatched</a></h5>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="panel bg-alert light of-h mb10">
      <div class="pn pl20 p5">
        ...
        <h5 class="text-muted"><a href="">Reviews awaiting approval</a></h5>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="panel bg-danger light of-h mb10">
      <div class="pn pl20 p5">
        ...
        <?php $setting = Modules\Shop\Models\Setting::where('key','low_inventory_amount')->value('value'); ?>
        <h5 class="text-muted"><a href="{{ route('gjadmin.shop.products.index') }}">Products with inventory less than {!! $setting !!}</a></h5>
      </div>
    </div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="panel bg-success light of-h mb10">
      <div class="pn pl20 p5">
        ...
        <?php $subscribers = App\Newsletter::where('status',1)->count(); ?>
        <h5 class="text-muted"><a href="{{ route('gjadmin.subscribers.index') }}">Newsletter subscribers</a></h5>
      </div>
    </div>
  </div>
    ...
    <div class="col-md-6 admin-grid">
      ...
      <div class="panel" id="p8">
        <div class="panel-heading">
          <span class="panel-title">Order Stats</span>
        </div>
        <div class="panel-body pn">
          <div class="row table-layout">
            <div class="col-xs-4 text-center posr">
              <i class="fa fa-usd icon-120 text-success"></i>
            </div>
            <div class="col-xs-8 br-l pn admin-form">
              ...
              $dateYesterday = Carbon\Carbon::yesterday();
              $weekStart  = date('Y-m-d 23-59-59', strtotime('-'.$day.' days'));

              $yesterday  = Modules\Shop\Models\Order::where('created_at', '>', $dateYesterday )->where('created_at', '<', $dateNow )->whereIn('status',array(1,3))->count();
              $today      = Modules\Shop\Models\Order::where('created_at','>',$dateNow)->whereIn('status',array(1,3))->count();
              $week       = Modules\Shop\Models\Order::where('created_at','>',$weekStart)->whereIn('status',array(1,3))->count();
              
              $month = Modules\Shop\Models\Order::where('created_at','>', date($dateNow->year.'-'.$dateNow->month.'-01 00:00:00'))->count(); 
              $year = Modules\Shop\Models\Order::where('created_at','>', date($dateNow->year.'-01-01 00:00:00'))->count(); 
                ...
                <tbody>
                  <tr>
                    <td class="va-m fw600 text-muted">
                      <span class="fa fa-calendar text-danger fs14 mr10"></span>Yesterday</td>
                    <td class="fs14 fw600 text-right">{{$yesterday}}</td>
                  </tr>
                  <tr>
                    <td class="va-m fw600 text-muted">
                      <span class="fa fa-calendar text-success fs14 mr10"></span>Today</td>
                    <td class="fs14 fw600 text-right">{{$today}}</td>
                  </tr>
                  <tr>
                    <td class="va-m fw600 text-muted">
                      <span class="fa fa-calendar text-info fs14 mr10"></span>This Week</td>
                    <td class="fs14 fw600 text-right">{{$week}}</td>
                  </tr>
                  <tr>
                    <td class="va-m fw600 text-muted">
                      <span class="fa fa-calendar text-primary fs15 mr10"></span>This Month</td>
                    <td class="fs14 fw600 text-right">{{$month}}</td>
                  </tr>
                  <tr>
                    <td class="va-m fw600 text-muted">
                      <span class="fa fa-calendar text-warning fs15 mr10"></span>This Year</td>
                    <td class="fs14 fw600 text-right">{{$year}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
