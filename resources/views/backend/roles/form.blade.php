<div class="tab-block mb25">
  <ul class="nav nav-tabs tabs-border">
    <li class="active">
      <a href="#user_details" data-toggle="tab" aria-expanded="true"> <i class="glyphicon glyphicon-user"></i> Role Details</a>
    </li>
    ...
    @if(isset($model))
	    <li class="dropdown">
	      ...
	      <ul class="dropdown-menu">
	        <li>
			{!! Former::open()->route('gjadmin.roles.destroy', $role->id)->method('DELETE')!!}    
			{!! Former::token() !!}                                  
  ...
  <div class="tab-content">
    ...
    {!! Former::open_vertical()->route('gjadmin.roles.update', $model->id)->method('PUT') !!}
                ...
                <div class="panel panel-dark heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="fa fa-pencil-square"></i>Role
                    </span>
                  </div>
            ...
            <div class="col-md-8">
              <div class="admin-form theme-dark tab-pane" id="register2" role="tabpanel">
                <div class="panel panel-dark heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="glyphicon glyphicon-user"></i> Role Permissions
                    </span>
                    ...
                    <div class="panel-body p25">
                      <div class="section-divider mt10 mb40">
                        <span>Role Permissions Details</span>
                      </div> <!-- .section-divider -->
                    ...
                    <div class="panel-footer">
                      <button type="submit" class="button btn-system dark">Update Role Permissions</button>
