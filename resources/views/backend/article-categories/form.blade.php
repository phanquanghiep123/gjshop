<div class="tab-block mb25">
  <ul class="nav nav-tabs tabs-border">
    <li class="active">
      <a href="#user_details" data-toggle="tab" aria-expanded="true"> <i class="glyphicon glyphicon-user"></i> Article Category Details</a>
    </li>
  ...
  <div class="tab-content">
    ...
    @if (isset($model))
        {!! Former::open_vertical()->route('gjadmin.article-categories.update',$model->id)->method('PUT') !!}
        {!! Former::populate($model) !!}
    @else
        {!! Form::open(['files' => true, 'route' => 'gjadmin.article-categories.store']) !!}
    @endif
        {!! Former::token() !!}
                ...
                <div class="panel panel-dark heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="glyphicon glyphicon-user"></i> Article Category Form
                    </span>
                  </div>
                  <!-- end .form-header section -->
                    ...
                    <div class="panel-body p25">
                      ...
                      <div class="section row">
                        ...
                        <div class="col-md-6">
                            {!! Former::select('parent_id','Parent Category')->fromQuery( \App\Category::root()->get(),'name','id')->addOption('None','0')->class('form-control') !!}
                        </div>
                      ...
                      <div class="section row">
                        ...
                        <div class="col-md-6">
                            {!! Former::text('position','Position:')->class('form-control')->placeholder('Position') !!}
                        </div>
                      </div><!-- end .section row section -->
                        ...
                        <div class="section row">
                            <div class="col-md-12">
                                {!! Former::textarea('description')->rows(6)->class('form-control') !!}
                            </div>
                        </div><!-- end .section row section -->
            ...
            <div class="col-md-4">
              ...
              <div class="admin-form theme-dark tab-pane" id="register2" role="tabpanel">
                <div class="panel panel-dark heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="fa fa-pencil-square"></i>Category Setttings
                    </span>
                  </div>
                  <!-- end .form-header section -->
