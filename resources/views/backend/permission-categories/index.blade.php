...
<ol class="breadcrumb">
    ...
    <li class="crumb-trail">Permission Categories</li>
</ol>
@stop
  ...
  <div class="panel panel-visible" id="spy5">
    <div class="panel-heading">
      <div class="panel-title hidden-xs">
        <span class="glyphicon glyphicon-tasks"></span>Registered Permission Categories</div>
    </div>
            ...
            <tbody>
                @foreach ($categories as $category)
	                <tr>
						...
						<td><a href="{!! route('gjadmin.permission-categories.edit', $category->id) !!}">{!! $category->name !!}</a></td>
	                        ...
	                        <div class="actions pull-right">
	                            <div class="btn-group">
	                              ...
	                              <ul class="dropdown-menu" role="menu">
	                                <li>
	                                    <a href="{!! route('gjadmin.permission-categories.edit', $category->id) !!}"> 
	                                        <i class="i"></i> <i class="fa fa-pencil"></i> Edit Category
	                                    </a>
	                                </li>
	                                <li class="divider"></li>
	                                <li>
	                                    {!! Form::open(['method' => 'DELETE', 'route' => ['gjadmin.permission-categories.destroy', $category->id]]) !!}                                    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		{!! Former::open_vertical()->route('gjadmin.permission-categories.store') !!}
		{!! Former::token() !!}

        {!! Former::text('name')->class('form-control')->required() !!}
        
        {!! Former::text('position')->class('form-control')->required() !!}
