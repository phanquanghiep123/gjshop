...
<ol class="breadcrumb">
    ...
    <li class="crumb-trail">Permissions Categories</li>
    <li class="crumb-trail">Edit Permission Category: {!! $category->name !!}</li>
</ol>
@stop
...
<div class="topbar-right hidden-xs hidden-sm">
    <a href="{!! route('gjadmin.permission-categories.index') !!}" class="btn btn-default btn-sm light fw600 ml10">
    ...
    <span class="fa fa-plus pr5"></span> Add Permission Category</a>
</div>
@stop
...
@section('content')
  @include('backend.permission-categories.form', ['model' => $category])
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {!! Former::open_vertical(route('gjadmin.permission-categories.store'),'POST') !!}
        {!! Former::token() !!}
