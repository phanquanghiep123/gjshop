<div class="tab-block mb25">
  <ul class="nav nav-tabs tabs-border">
    <li class="active">
      <a href="#user_details" data-toggle="tab" aria-expanded="true"> <i class="glyphicon glyphicon-user"></i> Permission Category Details</a>
    </li>
    ...
    @if(isset($model))
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
            {!! Former::open()->route('gjadmin.permission-categories.destroy', $model->id)->method('DELETE')!!}    
            {!! Former::token() !!}                                  
  ...
  <div class="tab-content">
    ...
    {!! Former::open_vertical()->route('gjadmin.permission-categories.update', $model->id)->method('PUT') !!}
                ...
                <div class="panel panel-dark heading-border">
                  <div class="panel-heading">
                    <span class="panel-title">
                      <i class="fa fa-pencil-square"></i>Permission Category
                    </span>
                  </div>
                  <!-- end .form-header section -->
                    ...
                    <div class="panel-body p25">
                      <div class="section-divider mt10 mb40">
                        <span>Permission Category Details</span>
                      </div>
                      <!-- .section-divider -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                            {!! Former::text('position')->class('form-control') !!}
                        </div> <!-- end section -->
                        <div class="col-md-12">
                    ...
                    <div class="panel-footer">
                      <button type="submit" class="button btn-system dark">Update Permission Category</button>
