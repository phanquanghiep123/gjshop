...
<title>Nurtured For Living | Account Created</title>
</head>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="400"></td>
                <td width="150">
                  <a href= "http://www.nurturedforliving.com" target="_blank">
        ...
        <tr>
          <td align="center">
            <font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#231f20; font-size:8px">
              <small>Nurtured For Living Ltd | PO box 69041, London, SW17 1FU | Tel: +44(0)207 993 6881 | <a href="mailto:info@nurturedforliving.com"  style="color:#010203; text-decoration:none">info@nurturedforliving.com</a></small></font></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
